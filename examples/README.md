...
[![Hackage Version](https://img.shields.io/hackage/v/yaya-examples)](https://hackage.haskell.org/package/yaya-examples)
[![Packaging status](https://repology.org/badge/tiny-repos/haskell:yaya-examples.svg)](https://repology.org/project/haskell:yaya-examples/versions)
[![latest packaged versions](https://repology.org/badge/latest-versions/haskell:yaya-examples.svg)](https://repology.org/project/haskell:yaya-examples/versions)

Small use cases for recursion schemes to illustrate how to use Yaya.

### yjq

A Yaya-based implementation of [jq](https://jqlang.org/) – the command-line JSON processor.

This illustrates

- implementation of pattern functors
- lexing
- parsing
- evaluation
