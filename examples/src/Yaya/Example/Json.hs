...
-- data Filter input output where
--   Identity :: Filter input input
--   ObjectIndex :: Text -> Filter input Object -> Filter input output
--   ArrayIndex :: Natural -> Filter input Array -> Filter input output
--   Slice :: Natural -> Natural -> Filter input ArrStr -> input ArrStr
--   Iterator :: Filter input ArrObj -> input output
--   Optional :: Filter input ArrObj -> Filter input output
